...
def get_parser():
    ...
    parser.add_argument(
        "--mimic_fname",
        type=str,
        default="./MIMIC_PREPROCESSED/{}_adm_{}.csv",
        help="args.task and split name",
    )
    parser.add_argument(
        "--retrieved_abstract_fname",
        type=str,
        default="./data/abstracts/{}.pubmed.texts_and_dates.pkl",
    )
    # Experimental path
    ...
    parser.add_argument(
        "--retriever_exp_path",
        type=str,
        default="./{}/retriever/vanilla/",
        help="args.seed",
    )
    parser.add_argument(
        "--reranker_exp_path",
        type=str,
        default="./{}/reranker/vanilla/",
        help="args.seed",
    )
    # Experiments for predictor
    parser.add_argument(
        "--task", type=str, choices=["MP_IN", "LOS_WEEKS"], default="MP_IN"
    )
    ...
    parser.add_argument(
        "--augment_strategy", type=str, choices=["avg", "wavg", "svote", "wvote"]
    )
    parser.add_argument(
        "--predictor_exp_path",
        type=str,
        default="./{}/predictor/task-{}.{}/",
        help="args.seed,args.task and args.predictor_exp_name",
    )
    ...
    parser.add_argument(
        "--encoded_abstract_fname",
        type=str,
        default="./data/abstracts/{}-retrieved/encoded_pubmed.pck",
        help="args.task",
    )
    ...
    parser.add_argument(
        "--retriever_ids_pck_path",
        type=str,
        default="./pickled/trec.retriever.{}.ids.pck",
    )
    parser.add_argument(
        "--reranker_ids_pck_path",
        type=str,
        default="./pickled/trec.reranker.{}.ids.pck",
    )
    parser.add_argument(
    ...
    args.predictor_exp_path = args.predictor_exp_path.format(
        args.model_path, args.task, args.predictor_exp_name
    )
    args.retrieved_abstract_fname = args.retrieved_abstract_fname.format(
        args.casual_task_name
    )
